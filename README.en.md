...
- Custom keys: a cap that sends a string of text, or a key sequence (`C-b d`, `M-.`, `F5`,
  `Up Up Enter`) picked from Ctrl / Alt / Shift toggles and key caps — a prefixed two-stroke
  tmux binding becomes one tap
